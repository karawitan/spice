...
#ifndef _GL_M4_STATIC_ASSERT_H
#define _GL_M4_STATIC_ASSERT_H
...
/* _GL_M4_STATIC_ASSERT_H is defined if this code is copied into assert.h.  */
#ifdef _GL_M4_STATIC_ASSERT_H
